...
export default function Home() {
    ...
    function resetTimelineResults(nextActiveDomain) {
    ...
    async function handleTrace(event) {
        ...
        try {
            ...
            resetTimelineResults(normalized);
            setError("No archive data found.");
        } finally {
            setIsLoading(false);
        }
                                            ...
                                            {years.map((year) => {
                                                ...
                                                return (
                                                    <button
                                                        ...
                                                        className={`border px-2 py-1 text-center ${isActive
                                        ...
                                        <div className="mt-3 border-t border-[#2a2a2a] pt-3">
                                            <div className="flex items-center justify-between gap-3">
                                                ...
                                                <button
                                                    ...
                                                    className={`border px-3 py-1 text-[11px] uppercase tracking-[0.08em] text-[#d4d3ce] ${playHistoryDisabled
